...
A Flask-based REST API for analyzing numbers and generating statistical reports. This backend provides endpoints to analyze numerical data, calculate statistics (mean, median, mode), and determine properties like prime numbers and perfect numbers.
